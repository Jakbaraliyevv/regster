...
// 1-YECHIM: Rasmlarni public papkasiga to'g'ri joylashtiring
// public/images/ papkasi yaratib, rasmlarni shu yerga qo'ying
...
const SimpleImageSwiper = () => {
  ...
  // YECHIM 1: Rasmlarni string path bilan import qiling
  const images = [
    {
      id: 1,
      src: "/heromage1.png", // public papkasidagi rasm
      alt: "Image 1",
    },
    {
      id: 2,
  ...
  // Yoki YECHIM 2: Base64 format yoki URL ishlatish
  // const images = [
  //   {
  //     id: 1,
  //     src: "https://your-domain.com/images/heromage1.png",
  //     alt: "Image 1",
  //   },
  //   // ... boshqa rasmlar
  // ];

  // Yoki YECHIM 3: Dynamic import
  ...
  //         import("../../../public/heromage1.png"),
  //         import("../../../public/heromage2.png"),
  //         import("../../../public/heromage3.png"),
  //         import("../../../public/heromage4.png"),
  //         import("../../../public/heromage5.png"),
  //       ]);

  //       const loadedImages = imageModules.map((module, index) => ({
  //         id: index + 1,
  //         src: module.default,
  //         alt: `Image ${index + 1}`,
  //       }));
  ...
  //       // Fallback rasmlar
  //       setImages([
  //         { id: 1, src: "/placeholder.png", alt: "Image 1" },
  //         // ... boshqa placeholder rasmlar
  //       ]);
  //     }
  //   };
  ...
  // YECHIM 4: Rasm yuklash xatoligini handle qilish
  const handleImageError = (e) => {
    console.error("Rasm yuklanmadi:", e.target.src);
    e.target.src = "/placeholder.png"; // default rasm
  };
              ...
              >
                <div className="relative group cursor-pointer">
                  <img
                    src={image.src}
                    alt={image.alt}
                    onError={handleImageError} // Xatolik handle qilish
                    className="w-56 sm:w-64 md:w-72 lg:w-80 h-40 sm:h-48 md:h-52 lg:h-60 object-cover rounded-xl sm:rounded-2xl shadow-2xl group-hover:shadow-3xl transition-all duration-500"
                  />
