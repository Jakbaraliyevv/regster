        ...
        <div className="w-1/2 relative overflow-hidden">
          ...
          <div className="relative h-full flex flex-col justify-center p-12">
            <div className="text-center mb-12">
              ...
              <p className="text-2xl font-light text-purple-500 mt-6 tracking-widest">
                Ilm, innovatsiya va kelajak sari!
              </p>
            </div>

            <div className="flex flex-col gap-[25px]">
              <p className="text-center text-[#3699de] font-medium text-[16px]">
            ...
            <div className="text-center mt-[40px]">
              <div className="relative group inline-block">
                ...
                <button className="relative px-8 py-4 bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 rounded-full text-white font-bold text-lg hover:scale-110 transform transition-all duration-300 shadow-2xl border-2 border-white/20 hover:border-white/40 group flex items-center justify-center gap-3">
          ...
          <div className="relative h-full">
            <div className="relative h-full overflow-hidden">
              ...
              {videos.slice(1).map((video, index) => {
                const angle = (index * 360) / 9; // 9 videos around circle
                const radius = 280;
